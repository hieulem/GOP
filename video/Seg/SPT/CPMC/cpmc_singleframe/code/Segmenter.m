        ...
        function obj = initialize(obj)  
            ...
            if(strcmp(obj.params.local_dist_type, 'pb'))
                ...
                if(~exist([obj.pb_path obj.img_name  '_PB.mat'], 'file'))
                    ...
                    [gPb_thin, gPb_fat, textons] = simpleGPb(obj.orig_I);
                    save([obj.pb_path obj.img_name  '_PB.mat'], 'gPb_thin', 'gPb_fat', 'textons');
                    
                    % replace gPb with efficient gb
                    % [gPb_orient, gPb_thin, textons] = globalPb_new_nofiles(obj.orig_I, [], 0.5);
                    % gPb_fat = mean(gPb_orient, 3);
                    % save([obj.pb_path obj.img_name  '_PB.mat'], 'gPb_thin', 'gPb_fat', 'textons');
