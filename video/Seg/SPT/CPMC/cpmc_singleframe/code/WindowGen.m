...
classdef WindowGen
    ...
    methods        
        ...
        function windows = apply(obj, detection_classes)
            load_save_loc = find(obj.load_save_path=='/',1,'last');
            if isempty(load_save_loc)
                load_save_loc = find(obj.load_save_path=='\',1,'last');
            end
            if ~exist(obj.load_save_path(1:load_save_loc),'dir')
                mkdir(obj.load_save_path(1:load_save_loc));
            end
