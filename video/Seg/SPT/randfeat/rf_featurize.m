...
%
% obj   - random feature object initialized by InitExplicitKernel.
% Napp  - (Optional) specifies the number of feature dimensions to be extracted. If 
%       this is not specified, then the algorithm takes the number of feature dimensions
%       specified in obj. If obj.method is signals then for each dimension 
%       one takes 2*floor(Napp/2)+1 samples, otherwise it is the number of terms in the MC approximation.
%
