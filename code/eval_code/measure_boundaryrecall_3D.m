function [scoreBr, scoreBp, BR_map_color] = measure_boundaryrecall_3D(gt_video, sv_video)
...
BrRetrieved = size(find(BR_sv==1),1);
scoreBr = 100*Boundary_recall/Boundary_total;
scoreBp = 100*Boundary_recall/BrRetrieved;
