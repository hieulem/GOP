function LTT=Computelongerterm(touchingmatrix,temporalsmoothing,framebelong, options, theoptiondata, filenames)
...
allintersectks=cell(1,noallsuperpixels);
...
%     if (~mod(i,1000))
%         fprintf('\b\b\b\b\b\b\b\b\b\b%010d',i);
%     end
end
% fprintf('\n');
fprintf('done, ');
