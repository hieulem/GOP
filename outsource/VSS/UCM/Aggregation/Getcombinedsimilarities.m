function [similarities,STT,LTT,ABA,ABM,STM,STA]=Getcombinedsimilarities(labelledlevelvideo,flows, ucm2, cim, mapped, ...
...
%$Hieu: I modified this code so that it saved the affinity matrix computed.
%Don't overided.
%Initialization
if ~exist(filenames.affinities)
    ...
    save(filenames.affinities,'STT','LTT','ABA','ABM','STM','STA','wgtsimilarities','similarities','mrgmth','mrgwgt','-v7.3');
else
    %@Hieu
    disp('Affinities computed, will be loaded');
