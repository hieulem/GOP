function asegmentation=Retrievevideosegmentations(filenames,additionalmasname,aparticularvideo,aparticularsegmentation,printonscreen)
...
for i = 1:numel(iids)
    ...
    for lev=1:numel(allthesegmentations) %#ok<USENS>
