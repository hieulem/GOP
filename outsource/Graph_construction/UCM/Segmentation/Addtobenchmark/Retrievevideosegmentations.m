...
%             Printthevideoonscreen_per_image('img',asegmentation, [], 2, true, [],true, true);   
...
%        cim=Readpictureseries([filesep,'BS',filesep,'vidsegmentHOrder',filesep,'work',filesep,'VideoProcessingTemp',filesep,aparticularvideo,filesep,'origimages',filesep,'image'],...
%             '%03d','.png',61,121);
%         videocorrectionparameters.rszratio=0.5;
%        cim =Adjustimagesize(cim,videocorrectionparameters,false);
%      Printthevideoonscreensuperposed(asegmentation, true, 1, true, [], false, true, cim,[]); %same as before but superposed
%    Printthevideoonscreen_per_image([],asegmentation, printonscreen, 1, false, 1, 1,false,[]);
