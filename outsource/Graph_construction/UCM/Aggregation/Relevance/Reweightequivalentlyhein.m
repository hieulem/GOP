function Wnew=Reweightequivalentlyhein(W,normpertrack,maxnotracks)
...
%         sizew=size(W,1);
%         [rrd2,ccd2,rcvd2]=Reweightequivalentlyheinloopmex(rr,rcv,normpertrack,maxnotracks,Z,sizew);
