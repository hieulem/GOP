...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) 
{
    ...
    int f,i,p,volumelabelidx,nl; // iterator variables
    int asp,touchedlabels,volumelabel,volumelabel_local,neighframe,neighlabel,neighlabel_local; //other integers
    int num_spatf,numberofsuperpixels,num_tempneighlabels,num_neighlabels;
    int num_touchedlabels, dimrow_median, dimcol_median;// count variables
    mwSize j,num_concc,num_conrr,num_constrr,num_framebelong;
    ...
    numberofsuperpixels = (int) *maxsuperpixels; 
       ...
       // BUG: FOUND THAT THE maxsuperpixelsperframe ALLO0CATES MEMORY THAT IS INSUFFICIENT IN SOME RARE CASES CAUSING MATLAB TO CRASH
// //  SOLVING IT BY ALLOCATING MORE MEMORY
   maxsuperpixelsperframe =  maxsuperpixels;
