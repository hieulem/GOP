function [similarities,framebelong]=Case_eight_frames_with_spatial(includenoise)
%[similarities,framebelong]=Case_eight_frames_with_spatial();
...
fnam=0.5; %not a match score for superpixels in the same frame
fam=0.5; %a match score for superpixels in the same frame
...
%spatial terms
similarities(1,2)=fnam;
similarities(5,6)=fnam;
similarities(9,10)=fnam;
similarities(13,14)=fnam;
similarities(17,18)=fnam;
similarities(21,22)=fnam;
similarities(25,26)=fnam;
similarities(29,30)=fnam;

similarities(3,4)=fnam;
similarities(6,8)=fnam;
similarities(11,12)=fnam;
similarities(15,16)=fnam;
similarities(20,18)=fnam;
similarities(24,23)=fnam;
similarities(28,27)=fnam;
similarities(32,31)=fnam;

similarities(3,2)=fam;
similarities(6,7)=fam;
similarities(10,11)=fam;
similarities(14,15)=fam;
similarities(18,19)=fam;
similarities(22,23)=fam;
similarities(26,27)=fam;
similarities(30,31)=fam;
