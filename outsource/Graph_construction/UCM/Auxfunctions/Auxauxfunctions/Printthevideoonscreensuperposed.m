...
if ( (size(thevideo,1)==0) || (size(thevideo,2)==0) )
    fprintf('Empty video\n');
    coloredvideo=[]; activeframes=[]; return;
end
...
Printthevideoonscreen_per_image('panda',coloredvideo, false, [], false, showcolorbar, true,false,outputfile,printthetext);
