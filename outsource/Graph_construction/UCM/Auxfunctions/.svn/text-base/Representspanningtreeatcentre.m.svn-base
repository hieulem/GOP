function Representspanningtreeatcentre(T,track,dist_track_mask,imagefc,nofigure,colourratio,colourforimage,colourforedges)
...
for i=1:numel(r)
    if (r(i)>=c(i))
        ...
        hold on
        line([track(fc,1,r(i));track(fc,1,c(i))],[track(fc,2,r(i));track(fc,2,c(i))],'Color','c');
        hold off
    end
end
