 ...
 * mex -largeArrayDims Measuresimilaritymex.cpp
*/
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) 
{
    ...
    mxLogical *newmask, *printonscreen; /* input arguments  */
    ...
    *similarity= (relevantpredicted+relevantnewmask) / (sumpredicted+sumnewmask);
    ...
    if (nrhs>2)
    {
        printonscreen = mxGetLogicals(prhs[2]);
        if ((bool)(*printonscreen))
