...
addpath(genpath('/Users/hieule/Project/GOP/outsource/toolbox-master'));
...
%load('flow.mat'); % 
tic;
flow = estimate_flow_interface(image, next_image, 'classic+nl-fast');
toc;
%load('backward_flow.mat'); % 
backward_flow = estimate_flow_interface(image, prev_image, 'classic+nl-fast');
